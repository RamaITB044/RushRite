...
const ItemCard = ({ item, cartQuantity, favorites, handleAddToCart, updateCartQuantity, toggleFavorite ,isCartPage}) => {
  ...
  return (
    <View style={styles.itemContainer}>
      ...
      <View style={styles.itemDetails}>
        ...
        {isCartPage && cartQuantity > 0 && (
          <Text style={styles.totalPrice}>Total: ₹ {(item.price * cartQuantity).toFixed(2)}</Text>
        )}
      </View>
    </View>
  );
